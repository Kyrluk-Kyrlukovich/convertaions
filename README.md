...
| Нотация   | Описание                        | Пример алгоритма                                            | Рост при n          |
|-----------|---------------------------------|-------------------------------------------------------------|---------------------|
| O(1)      | Константное время               | Доступ к элементу массива по индексу                        | Постоянный         |  
| O(log n)  | Логарифмическое время           | Бинарный поиск                                              | Медленный рост     |  
| O(n)      | Линейное время                  | Линейный поиск                                              | Пропорциональный   |  
| O(n log n)| Логлинейное время              | Быстрая сортировка, сортировка слиянием                     | Умеренный рост     |  
| O(n²)     | Квадратичное время              | Сортировка пузырьком, сортировка вставками (худший случай)  | Быстрый рост       |  
| O(2ⁿ)     | Экспоненциальное время          | Решение задачи о рюкзаке перебором всех подмножеств         | Очень быстрый рост |  
| O(n!)     | Факториальное время             | Перебор всех перестановок                                   | Невероятно быстрый рост |
